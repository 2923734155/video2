...
$('nav .nav_down').mouseenter(function () {
    ...
    $(this).children('img').attr('src', 'http://localhost:8080/video2/img/nav_down2.png');
});
$('nav .nav_down').mouseleave(function () {
    $('#nav_down').stop().slideUp();
    $(this).children('img').attr('src', 'http://localhost:8080/video2/img/nav_down.png');
});
...
function commitLogin(){
   ...
   if(null!=email && email!="" && null!=password && password!=""){
        ...
        // alert(params);
        // post要小写
        $.post("/video2/user/loginUser.do",params,function(data){
        // alert(data);
                 if(data=='success'){
